...
//		this.FILLER = Arrays.copyOfRange(subSize, 173, 180);
	...
	public String toString() {
		return "MybiRecord [DATA구분=" + Arrays.toString(DATA구분) + ", 사업자번호=" + Arrays.toString(사업자번호) + ", 운수사="
				...
				+ Arrays.toString(카드사명) + ", 단말코드=" + Arrays.toString(단말코드) + ", 버스구분=" + Arrays.toString(버스구분)
				+ ", 차량번호=" + Arrays.toString(차량번호) + ", 노선코드=" + Arrays.toString(노선코드) + ", 정류장코드="
				+ Arrays.toString(정류장코드) + ", 정류장명=" + Arrays.toString(정류장명) + ", 일반건수=" + Arrays.toString(일반건수)
				+ ", 학생건수=" + Arrays.toString(학생건수) + ", 소인건수=" + Arrays.toString(소인건수) + ", 기타건수="
				+ Arrays.toString(기타건수) + ", 거래금액=" + Arrays.toString(거래금액) + ", 환승FLAG=" + Arrays.toString(환승FLAG)
				+ ", 이전노선코드=" + Arrays.toString(이전노선코드) + ", 이전거래일자=" + Arrays.toString(이전거래일자) + ", 이전거래시간="
				+ Arrays.toString(이전거래시간) + ", 이전정류장코드=" + Arrays.toString(이전정류장코드) + ", 이전정류장명="
				+ Arrays.toString(이전정류장명) + ", FILLER=" + Arrays.toString(FILLER) + "]";
	}
